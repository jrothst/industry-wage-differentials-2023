% M4: OLS, industry and CZ FEs, time-varying + time-invariant controls (+ educ)
...
disp('AKM estimation - model 4 - top 59A')
...
s=['[DATA]/M4_AKM_top59A.txt'];
dlmwrite(s, out2, 'delimiter', '\t', 'precision', 16);
clear out1 out2;

disp('Saving xb')
out=[id_old year xb];
s=['[DATA]/M4_AKM_top59A_xb.txt'];
dlmwrite(s, out, 'delimiter', '\t', 'precision', 16);
